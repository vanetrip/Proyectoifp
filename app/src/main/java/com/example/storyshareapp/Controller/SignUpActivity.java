...
import com.example.storyshareapp.Persistencia.Usuario;
    ...
    public class SignUpActivity extends AppCompatActivity {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            editText1 = findViewById(R.id.editText1_SignUp);
            editText2 = findViewById(R.id.editText2_SignUp);
            editText3 = findViewById(R.id.editText3_SignUp);
            editText4 = findViewById(R.id.editText4_SignUp);
            editText5 = findViewById(R.id.editText5_SignUp);
            editText6 = findViewById(R.id.editText6_SignUp);
            button1 = findViewById(R.id.button1_signUp);

            basedeDatos = new BasedeDatos(this); // Aquí se pasa el contexto de la actividad
            ...
            button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    nuevoUsuario.setEdad(Integer.parseInt(age));
                    ...
                    int usuarioInsertado = basedeDatos.insertarUsuario(nuevoUsuario);
